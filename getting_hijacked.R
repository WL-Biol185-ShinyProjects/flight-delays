...
getting_hijacked <- tabPanel('Crash Data',
   tags$script(HTML("document.querySelectorAll('[data-value=\"Crash Data\"]')[1].style.paddingLeft = \"4vw\"; document.querySelectorAll('[data-value=\"Crash Data\"]')[1].style.paddingRight = \"4vw\";")),
